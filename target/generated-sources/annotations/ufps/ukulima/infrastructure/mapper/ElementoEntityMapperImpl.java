...
public class ElementoEntityMapperImpl implements ElementoEntityMapper {
    ...
    protected RelacionBase relacionBaseEntityToRelacionBase(RelacionBaseEntity relacionBaseEntity) {
        ...
        relacionBase.setIdElemento1( toDomain( relacionBaseEntity.getIdElemento1() ) );
        relacionBase.setIdElemento2( toDomain( relacionBaseEntity.getIdElemento2() ) );
        relacionBase.setIdElemento3( toDomain( relacionBaseEntity.getIdElemento3() ) );
    ...
    protected AnalisisElementoInterpretacion analisisElementoInterpretacionEntityToAnalisisElementoInterpretacion(AnalisisElementoInterpretacionEntity analisisElementoInterpretacionEntity) {
        ...
        idElemento = toDomain( analisisElementoInterpretacionEntity.getIdElemento() );
