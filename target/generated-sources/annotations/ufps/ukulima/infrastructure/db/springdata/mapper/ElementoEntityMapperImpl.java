...
@Generated(value = "org.mapstruct.ap.MappingProcessor", date = "2022-10-01T23:22:20-0500", comments = "version: 1.3.1.Final, compiler: Eclipse JDT (IDE) 1.4.200.v20220802-0458, environment: Java 17.0.4.1 (Eclipse Adoptium)")
@Component
public class ElementoEntityMapperImpl implements ElementoEntityMapper {
    ...
    protected AnalisisElemento analisisElementosEntityToAnalisisElemento(
        ...
        analisisElemento.setIdElemento(toDomain(analisisElementosEntity.getIdElemento()));
    ...
    protected FuenteRecomendacionEntity fuenteRecomendacionToFuenteRecomendacionEntity(
        ...
        fuenteRecomendacionEntity.setIdElemento(toEntity(fuenteRecomendacion.getIdElemento()));
    ...
    protected AnalisisElementosEntity analisisElementoToAnalisisElementosEntity(AnalisisElemento analisisElemento) {
        ...
        analisisElementosEntity.setIdElemento(toEntity(analisisElemento.getIdElemento()));
