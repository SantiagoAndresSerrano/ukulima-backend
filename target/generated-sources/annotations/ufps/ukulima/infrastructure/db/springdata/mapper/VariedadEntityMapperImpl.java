...
@Generated(value = "org.mapstruct.ap.MappingProcessor", date = "2022-10-01T23:22:19-0500", comments = "version: 1.3.1.Final, compiler: Eclipse JDT (IDE) 1.4.200.v20220802-0458, environment: Java 17.0.4.1 (Eclipse Adoptium)")
@Component
public class VariedadEntityMapperImpl implements VariedadEntityMapper {
    ...
    protected Collection<Variedad> variedadEntityCollectionToVariedadCollection(Collection<VariedadEntity> collection) {
        ...
        for (VariedadEntity variedadEntity : collection) {
            collection1.add(toDomain(variedadEntity));
        }
    ...
    protected Cultivo cultivoEntityToCultivo(CultivoEntity cultivoEntity) {
        ...
        cultivo.setIdVariedad(toDomain(cultivoEntity.getIdVariedad()));
    ...
    protected CultivoEntity cultivoToCultivoEntity(Cultivo cultivo) {
        ...
        cultivoEntity.setIdVariedad(toEntity(cultivo.getIdVariedad()));
