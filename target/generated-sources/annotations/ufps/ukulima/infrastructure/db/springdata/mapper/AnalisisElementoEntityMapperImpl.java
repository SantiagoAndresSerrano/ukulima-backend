...
@Generated(value = "org.mapstruct.ap.MappingProcessor", date = "2022-10-01T23:22:33-0500", comments = "version: 1.3.1.Final, compiler: Eclipse JDT (IDE) 1.4.200.v20220802-0458, environment: Java 17.0.4.1 (Eclipse Adoptium)")
@Component
public class AnalisisElementoEntityMapperImpl implements AnalisisElementoEntityMapper {
    ...
    public AnalisisElemento toDomain(AnalisisElementosEntity AnalisisElementoEntity) {
        ...
        analisisElemento
                .setIdAnalisisSuelo(analisisSueloEntityToAnalisisSuelo(AnalisisElementoEntity.getIdAnalisisSuelo()));
        analisisElemento.setIdElemento(elementoEntityToElemento(AnalisisElementoEntity.getIdElemento()));
    ...
    public AnalisisElementosEntity toEntity(AnalisisElemento AnalisisElemento) {
        ...
        analisisElementosEntity
                .setIdAnalisisSuelo(analisisSueloToAnalisisSueloEntity(AnalisisElemento.getIdAnalisisSuelo()));
    ...
    @Override
    public List<AnalisisElemento> abonosOrganicosRecomendacionToDomain(
            List<AnalisisElementosEntity> abonoOrganicoEntities) {
    ...
    protected Collection<AnalisisElemento> analisisElementosEntityCollectionToAnalisisElementoCollection(
        ...
        for (AnalisisElementosEntity analisisElementosEntity : collection) {
            collection1.add(toDomain(analisisElementosEntity));
        }
    ...
    protected Elemento elementoEntityToElemento(ElementoEntity elementoEntity) {
        ...
        elemento.setAnalisisElementoCollection(analisisElementosEntityCollectionToAnalisisElementoCollection(
                elementoEntity.getAnalisisElementoCollection()));
    ...
    protected Recomendacion recomendacionEntityToRecomendacion(RecomendacionEntity recomendacionEntity) {
        ...
        recomendacion.setAbonoOrganicoRecomendacionCollection(
                abonoOrganicoRecomendacionEntityCollectionToAbonoOrganicoRecomendacionCollection(
                        recomendacionEntity.getAbonoOrganicoRecomendacionCollection()));
        recomendacion
    ...
    protected Collection<AnalisisSuelo> analisisSueloEntityCollectionToAnalisisSueloCollection(
            Collection<AnalisisSueloEntity> collection) {
        if (collection == null) {
            return null;
        }
    ...
    protected ClaseTextural claseTexturalEntityToClaseTextural(ClaseTexturalEntity claseTexturalEntity) {
        ...
        claseTextural.setAnalisisSueloCollection(analisisSueloEntityCollectionToAnalisisSueloCollection(
                claseTexturalEntity.getAnalisisSueloCollection()));
    ...
    protected DistanciaSiembra distanciaSiembraEntityToDistanciaSiembra(DistanciaSiembraEntity distanciaSiembraEntity) {
        ...
        distanciaSiembra.setCultivoCollection(
                cultivoEntityCollectionToCultivoCollection(distanciaSiembraEntity.getCultivoCollection()));
    ...
    protected EtapaFenologica etapaFenologicaEntityToEtapaFenologica(EtapaFenologicaEntity etapaFenologicaEntity) {
        ...
        etapaFenologica.setCultivoCollection(
                cultivoEntityCollectionToCultivoCollection(etapaFenologicaEntity.getCultivoCollection()));
    ...
    protected Topografia topografiaEntityToTopografia(TopografiaEntity topografiaEntity) {
        ...
        topografia.setCultivoCollection(
                cultivoEntityCollectionToCultivoCollection(topografiaEntity.getCultivoCollection()));
    ...
    protected TipoCultivo tipoCultivoEntityToTipoCultivo(TipoCultivoEntity tipoCultivoEntity) {
        ...
        tipoCultivo.setVariedadCollection(
                variedadEntityCollectionToVariedadCollection(tipoCultivoEntity.getVariedadCollection()));
    ...
    protected Variedad variedadEntityToVariedad(VariedadEntity variedadEntity) {
        ...
        variedad.setCultivoCollection(
                cultivoEntityCollectionToCultivoCollection(variedadEntity.getCultivoCollection()));
    ...
    protected Cultivo cultivoEntityToCultivo(CultivoEntity cultivoEntity) {
        ...
        cultivo.setAnalisisSueloCollection(
                analisisSueloEntityCollectionToAnalisisSueloCollection(cultivoEntity.getAnalisisSueloCollection()));
    ...
    protected Densidad densidadEntityToDensidad(DensidadEntity densidadEntity) {
        ...
        densidad.setAnalisisSueloCollection(
                analisisSueloEntityCollectionToAnalisisSueloCollection(densidadEntity.getAnalisisSueloCollection()));
    ...
    protected ProfundidadMuestra profundidadMuestraEntityToProfundidadMuestra(
        ...
        profundidadMuestra.setAnalisisSueloCollection(analisisSueloEntityCollectionToAnalisisSueloCollection(
                profundidadMuestraEntity.getAnalisisSueloCollection()));
    ...
    protected AnalisisSuelo analisisSueloEntityToAnalisisSuelo(AnalisisSueloEntity analisisSueloEntity) {
        ...
        analisisSuelo.setAnalisisElementoCollection(analisisElementosEntityCollectionToAnalisisElementoCollection(
                analisisSueloEntity.getAnalisisElementoCollection()));
    ...
    protected EnmiendaEntity enmiendaToEnmiendaEntity(Enmienda enmienda) {
        ...
        enmiendaEntity.setRecomendacionCollection(
                recomendacionCollectionToRecomendacionEntityCollection(enmienda.getRecomendacionCollection()));
    ...
    protected Collection<AnalisisElementosEntity> analisisElementoCollectionToAnalisisElementosEntityCollection(
        ...
        for (AnalisisElemento analisisElemento : collection) {
            collection1.add(toEntity(analisisElemento));
        }
    ...
    protected FuenteEntity fuenteToFuenteEntity(Fuente fuente) {
        ...
        fuenteEntity
                .setFuenteRecomendacionCollection(fuenteRecomendacionCollectionToFuenteRecomendacionEntityCollection(
                        fuente.getFuenteRecomendacionCollection()));
    ...
    protected RecomendacionEntity recomendacionToRecomendacionEntity(Recomendacion recomendacion) {
        ...
        recomendacionEntity.setAbonoOrganicoRecomendacionCollection(
                abonoOrganicoRecomendacionCollectionToAbonoOrganicoRecomendacionEntityCollection(
                        recomendacion.getAbonoOrganicoRecomendacionCollection()));
        recomendacionEntity
                .setFuenteRecomendacionCollection(fuenteRecomendacionCollectionToFuenteRecomendacionEntityCollection(
                        recomendacion.getFuenteRecomendacionCollection()));

        return recomendacionEntity;
    }

    protected Collection<AnalisisSueloEntity> analisisSueloCollectionToAnalisisSueloEntityCollection(
            Collection<AnalisisSuelo> collection) {
        if (collection == null) {
            return null;
        }
    ...
    protected ClaseTexturalEntity claseTexturalToClaseTexturalEntity(ClaseTextural claseTextural) {
        ...
        claseTexturalEntity.setAnalisisSueloCollection(
                analisisSueloCollectionToAnalisisSueloEntityCollection(claseTextural.getAnalisisSueloCollection()));
    ...
    protected DistanciaSiembraEntity distanciaSiembraToDistanciaSiembraEntity(DistanciaSiembra distanciaSiembra) {
        ...
        distanciaSiembraEntity.setCultivoCollection(
                cultivoCollectionToCultivoEntityCollection(distanciaSiembra.getCultivoCollection()));
    ...
    protected EtapaFenologicaEntity etapaFenologicaToEtapaFenologicaEntity(EtapaFenologica etapaFenologica) {
        ...
        etapaFenologicaEntity.setCultivoCollection(
                cultivoCollectionToCultivoEntityCollection(etapaFenologica.getCultivoCollection()));
    ...
    protected TopografiaEntity topografiaToTopografiaEntity(Topografia topografia) {
        ...
        topografiaEntity
                .setCultivoCollection(cultivoCollectionToCultivoEntityCollection(topografia.getCultivoCollection()));
    ...
    protected TipoCultivoEntity tipoCultivoToTipoCultivoEntity(TipoCultivo tipoCultivo) {
        ...
        tipoCultivoEntity.setVariedadCollection(
                variedadCollectionToVariedadEntityCollection(tipoCultivo.getVariedadCollection()));
    ...
    protected VariedadEntity variedadToVariedadEntity(Variedad variedad) {
        ...
        variedadEntity
                .setCultivoCollection(cultivoCollectionToCultivoEntityCollection(variedad.getCultivoCollection()));
    ...
    protected CultivoEntity cultivoToCultivoEntity(Cultivo cultivo) {
        ...
        cultivoEntity.setAnalisisSueloCollection(
                analisisSueloCollectionToAnalisisSueloEntityCollection(cultivo.getAnalisisSueloCollection()));
    ...
    protected DensidadEntity densidadToDensidadEntity(Densidad densidad) {
        ...
        densidadEntity.setAnalisisSueloCollection(
                analisisSueloCollectionToAnalisisSueloEntityCollection(densidad.getAnalisisSueloCollection()));
    ...
    protected ProfundidadMuestraEntity profundidadMuestraToProfundidadMuestraEntity(
        ...
        profundidadMuestraEntity.setAnalisisSueloCollection(analisisSueloCollectionToAnalisisSueloEntityCollection(
                profundidadMuestra.getAnalisisSueloCollection()));
    ...
    protected AnalisisSueloEntity analisisSueloToAnalisisSueloEntity(AnalisisSuelo analisisSuelo) {
        ...
        analisisSueloEntity.setAnalisisElementoCollection(analisisElementoCollectionToAnalisisElementosEntityCollection(
                analisisSuelo.getAnalisisElementoCollection()));
