...
@Generated(value = "org.mapstruct.ap.MappingProcessor", date = "2022-10-01T23:22:23-0500", comments = "version: 1.3.1.Final, compiler: Eclipse JDT (IDE) 1.4.200.v20220802-0458, environment: Java 17.0.4.1 (Eclipse Adoptium)")
@Component
public class DistanciaSiembraEntityMapperImpl implements DistanciaSiembraEntityMapper {
    ...
    @Override
    public List<DistanciaSiembra> abonosOrganicosRecomendacionToDomain(
            List<DistanciaSiembraEntity> abonoOrganicoEntities) {
    ...
    protected Cultivo cultivoEntityToCultivo(CultivoEntity cultivoEntity) {
        ...
        cultivo.setIdDistanciaSiembra(toDomain(cultivoEntity.getIdDistanciaSiembra()));
    ...
    protected CultivoEntity cultivoToCultivoEntity(Cultivo cultivo) {
        ...
        cultivoEntity.setIdDistanciaSiembra(toEntity(cultivo.getIdDistanciaSiembra()));
