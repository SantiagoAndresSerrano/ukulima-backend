...
@Generated(value = "org.mapstruct.ap.MappingProcessor", date = "2022-10-01T22:28:36-0500", comments = "version: 1.3.1.Final, compiler: Eclipse JDT (IDE) 1.4.200.v20220802-0458, environment: Java 17.0.4.1 (Eclipse Adoptium)")
@Component
public class EtapaFenologicaEntityMapperImpl implements EtapaFenologicaEntityMapper {
    ...
    @Override
    public List<EtapaFenologica> abonosOrganicosRecomendacionToDomain(
            List<EtapaFenologicaEntity> abonoOrganicoEntities) {
    ...
    protected Cultivo cultivoEntityToCultivo(CultivoEntity cultivoEntity) {
        ...
        cultivo.setIdEtapaFenologica(toDomain(cultivoEntity.getIdEtapaFenologica()));
    ...
    protected CultivoEntity cultivoToCultivoEntity(Cultivo cultivo) {
        ...
        cultivoEntity.setIdEtapaFenologica(toEntity(cultivo.getIdEtapaFenologica()));
