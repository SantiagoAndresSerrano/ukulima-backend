...
public class TipoIdentificacionEntityMapperImpl implements TipoIdentificacionEntityMapper {
    ...
    public TipoIdentificacion toDomain(TipoIdentificacionEntity TipoIdentificacionEntity) {
        ...
        tipoIdentificacion.setAgricultorCollection( agricultorEntityCollectionToAgricultorCollection( TipoIdentificacionEntity.getAgricultorCollection() ) );
    ...
    public TipoIdentificacionEntity toEntity(TipoIdentificacion TipoIdentificacion) {
        ...
        tipoIdentificacionEntity.setAgricultorCollection( agricultorCollectionToAgricultorEntityCollection( TipoIdentificacion.getAgricultorCollection() ) );
    ...
    protected Agricultor agricultorEntityToAgricultor(AgricultorEntity agricultorEntity) {
        ...
        agricultor.setIdTipoIdentificacion( toDomain( agricultorEntity.getIdTipoIdentificacion() ) );
        agricultor.setFincaCollection( fincaEntityCollectionToFincaCollection( agricultorEntity.getFincaCollection() ) );

        return agricultor;
    }

    protected Collection<Agricultor> agricultorEntityCollectionToAgricultorCollection(Collection<AgricultorEntity> collection) {
        if ( collection == null ) {
            return null;
        }

        Collection<Agricultor> collection1 = new ArrayList<Agricultor>( collection.size() );
        for ( AgricultorEntity agricultorEntity : collection ) {
            collection1.add( agricultorEntityToAgricultor( agricultorEntity ) );
        }
    ...
    protected AgricultorEntity agricultorToAgricultorEntity(Agricultor agricultor) {
        ...
        agricultorEntity.setIdTipoIdentificacion( toEntity( agricultor.getIdTipoIdentificacion() ) );
        agricultorEntity.setFincaCollection( fincaCollectionToFincaEntityCollection( agricultor.getFincaCollection() ) );

        return agricultorEntity;
    }

    protected Collection<AgricultorEntity> agricultorCollectionToAgricultorEntityCollection(Collection<Agricultor> collection) {
        if ( collection == null ) {
            return null;
        }

        Collection<AgricultorEntity> collection1 = new ArrayList<AgricultorEntity>( collection.size() );
        for ( Agricultor agricultor : collection ) {
            collection1.add( agricultorToAgricultorEntity( agricultor ) );
        }
