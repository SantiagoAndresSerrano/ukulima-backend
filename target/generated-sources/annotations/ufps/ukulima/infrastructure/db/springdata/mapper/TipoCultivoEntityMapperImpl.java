...
@Generated(value = "org.mapstruct.ap.MappingProcessor", date = "2022-10-01T23:22:26-0500", comments = "version: 1.3.1.Final, compiler: Eclipse JDT (IDE) 1.4.200.v20220802-0458, environment: Java 17.0.4.1 (Eclipse Adoptium)")
@Component
public class TipoCultivoEntityMapperImpl implements TipoCultivoEntityMapper {
    ...
    protected Variedad variedadEntityToVariedad(VariedadEntity variedadEntity) {
        ...
        variedad.setIdTipoCultivo(toDomain(variedadEntity.getIdTipoCultivo()));
    ...
    protected VariedadEntity variedadToVariedadEntity(Variedad variedad) {
        ...
        variedadEntity.setIdTipoCultivo(toEntity(variedad.getIdTipoCultivo()));
        variedadEntity
