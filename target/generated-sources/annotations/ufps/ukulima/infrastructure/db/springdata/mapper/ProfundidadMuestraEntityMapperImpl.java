...
@Generated(value = "org.mapstruct.ap.MappingProcessor", date = "2022-10-01T22:28:38-0500", comments = "version: 1.3.1.Final, compiler: Eclipse JDT (IDE) 1.4.200.v20220802-0458, environment: Java 17.0.4.1 (Eclipse Adoptium)")
@Component
public class ProfundidadMuestraEntityMapperImpl implements ProfundidadMuestraEntityMapper {
    ...
    @Override
    public List<ProfundidadMuestra> abonosOrganicosRecomendacionToDomain(
            List<ProfundidadMuestraEntity> abonoOrganicoEntities) {
    ...
    protected AnalisisElemento analisisElementosEntityToAnalisisElemento(
        ...
        analisisElemento
                .setIdAnalisisSuelo(analisisSueloEntityToAnalisisSuelo(analisisElementosEntity.getIdAnalisisSuelo()));
    ...
    protected AnalisisSuelo analisisSueloEntityToAnalisisSuelo(AnalisisSueloEntity analisisSueloEntity) {
        ...
        analisisSuelo.setIdProfundidad(toDomain(analisisSueloEntity.getIdProfundidad()));
    ...
    protected AnalisisSueloEntity analisisSueloToAnalisisSueloEntity(AnalisisSuelo analisisSuelo) {
        ...
        analisisSueloEntity.setIdProfundidad(toEntity(analisisSuelo.getIdProfundidad()));
